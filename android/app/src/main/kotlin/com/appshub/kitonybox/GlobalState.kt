...
import com.appshub.kitonybox.plugins.AppPlugin
import com.appshub.kitonybox.plugins.ServicePlugin
import com.appshub.kitonybox.plugins.TilePlugin
...
object GlobalState {
    ...
    const val NOTIFICATION_CHANNEL = "KitonyBox"
    ...
    fun isCurrentlyStopping(): Boolean {
        ...
        return runCatching {
            val sp = KitonyBoxApplication.getAppContext()
                .getSharedPreferences("vpn_state", android.content.Context.MODE_PRIVATE)
    ...
    fun initServiceEngine(flags: List<String>? = null) {
        runLock.withLock {
            ...
            val app = KitonyBoxApplication.getAppContext() as KitonyBoxApplication
