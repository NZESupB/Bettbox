...
import com.appshub.kitonybox.extensions.getIpv4RouteAddress
import com.appshub.kitonybox.extensions.getIpv6RouteAddress
import com.appshub.kitonybox.extensions.toCIDR
import com.appshub.kitonybox.models.AccessControlMode
import com.appshub.kitonybox.models.VpnOptions
import com.appshub.kitonybox.plugins.VpnPlugin
import com.appshub.kitonybox.R
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.launch

class KitonyBoxVpnService : VpnService(), BaseServiceInterface {
    companion object {
        private const val TAG = "KitonyBoxVpnService"
    }
    ...
    private suspend fun notificationBuilder(): NotificationCompat.Builder {
        if (cachedBuilder == null) {
            cachedBuilder = createKitonyBoxNotificationBuilder()
        }
    ...
    inner class LocalBinder : Binder() {
        fun getService(): KitonyBoxVpnService = this@KitonyBoxVpnService
