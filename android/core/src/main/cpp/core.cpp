...
Java_com_appshub_kitonybox_core_Core_startTun(JNIEnv *env, jobject, const jint fd, jobject cb) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_appshub_kitonybox_core_Core_stopTun(JNIEnv *) {
    stopTun();
}

extern "C"
JNIEXPORT void JNICALL
Java_com_appshub_kitonybox_core_Core_suspend(JNIEnv *, jobject, jint suspended) {
    suspend(suspended);
}
...
JNI_OnLoad(JavaVM *vm, void *) {
    ...
    const auto c_tun_interface = find_class("com/appshub/kitonybox/core/TunInterface");
